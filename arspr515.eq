/* arspr505.eq
   ...
   prints d/b outstanding receivables by Policy Number - Eff Date Aging
                                                         
*/  
description Direct Bill Outstanding Receivalbes by Policy Number - Eff Date Aging  ;

define string l_report_title[60]="Direct Bill Aged Receivables - Effective Date"

define date l_as_of = parameter/cls/prompt="Enter As of Date<NL> "

define unsigned ascii number l_days_past = (l_as_of - arsbilling:trans_eff)
...
define string l_report_no = "ARSPR515"  

where -- arsbilling:status <> "P" and
(arsbilling:due_date <= l_as_of and
 arsbilling:trans_eff <= l_as_of)
...
l_as_of/heading="As of "/column=105/newline=2/mask="M(15) D(2), Y(4)"
