...
*/                                           
description 
Cash processed by Effective Year and Month of Policy - Spreadsheet Output;
...
sorted by year(arschksu:trans_eff)/newpage 
          month(arschksu:trans_eff)/newlines
          arschksu:trans_eff
          arschksu:policy_no 
...
top of page 
""/newline
year(arschksu:trans_eff)/heading="Effective Year"/newline
