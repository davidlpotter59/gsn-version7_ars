/*  arspr062
    ...
    agents A/C commission statements
    processed not paid
...
define string l_report_title[50]="ACCOUNT CURRENT COMMISSION STATEMENT"
define string l_report_number[15]="ARSPR062" 
...
((arsmaster:trans_date < l_starting_date and
  ...
  arsmaster:trans_exp <= l_ending_date) or
 (arsmaster:trans_date => l_starting_date and
...
((arsmaster:trans_date < l_starting_date_1 and
  ...
  arsmaster:trans_exp <= l_ending_date_1) or
 (arsmaster:trans_date => l_starting_date_1 and
...
define signed ascii number l_net_due =
l_current_premium - l_current_comm 
...
arsmaster:bill_plan = "AC" and -- added July 31, 2001 (DLP)
arsmaster:trans_code not one of 18,19,28,29
...
""/newline
"<033>&a3560h6900V"
total[l_net_due,arsmaster:agent_no]/mask="(ZZ,ZZZ,ZZZ.99)"
