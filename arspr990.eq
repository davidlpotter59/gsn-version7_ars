/*  arspr990
    ...
    report to show policies out of balance between arsmaster and arsbilling 
*/

description The report will show the differences between ARSMASTER and ARSBILLING records.  Note:  If the records
...
where arsmaster:trans_date => l_starting_date and 
      ...
      arsmaster:trans_code < 17

list
/nobanner
/domain="arsmaster"
/title="Balacing errors between ARSMASTER and ARSBILLING"
/nodetail
/noreporttotals 
...
if total[arsmaster:premium ] <> total[arsbilling:installment_amount] then 
{
box/noheadings 
    arsmaster:policy_no /column=1
    arsmaster:trans_date /column=15
