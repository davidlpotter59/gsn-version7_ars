/*  arsdeposit
    ...
    Report program to generate the deposit ticket.   the naming
    convention is not the same as all other SCIPS programs.  this
    is to allow each user to have their own formatting of the deposit
...
where arschksu:trans_date => l_starting_date and
      ...
      arschksu:disposition = "CLEAR" and  -- must be clear, anyother disposition would indicate"
      arschksu:internal_check = 0         -- that the check has not be fully processed
      and check_no[1,2] not one of "CC","cc","Cc","cC"
list
/nobanner
/domain="arschksu"
/notitle
