/*  arspr001.eq
    ...
    april 11, 2001
    copied from arspr001.eq - July 15, 2001
...
define signed ascii number l_total_due_total = arsfinder:annual_premium - 
...
"^",str(arsbilling:net_amount_due,"-$ZZ,ZZZ.99")))
...
define signed ascii number l_total_ann_premium = if arsbilling:trans_code <> 18 
and arsbilling:trans_code <> 28 then
arsbilling:installment_amount 
else
0.00/decimalplaces=2
...
"<033>&a4700h80V"
l_arial_bold
arsfinder:copy_literal/noheading
""/newline
"<033>&a+0h-120V"
...
if total[l_total_premium, arsbilling:trans_code] > 0 then
{
...
if arsbilling:trans_code <> 18 and
   arsbilling:trans_code <> 19 then 
   {l_transaction_type}
else
...
if total[l_total_premium, arsbilling:due_date] > 0 then
{
"Total for Due Date"
"<033>&a3780h+0V"
arsbilling:due_date/noheading/mask="MM/DD/YYYY"
...
"<033>&a2380h+240V"
-- august 29, 2001 dlp do not print 0 amount due
if total[l_total_due, arsfinder:copy_ctr] <> 0 then
{
"Total Due "
"<033>&a4636h+0V"
total[l_total_due,arsfinder:copy_ctr]/noheading/mask="$ZZ,ZZZ.99-"
--total[arsbilling:installment_amount,arsfinder:copy_ctr]/noheading/mask=
--"$$Z,ZZZ.99-"
"<033>&a2380h+360V"
}
...
""/newline
"<033>&a4560h5640V"
total[l_total_due,arsfinder:copy_ctr]/mask="$ZZ,ZZZ.99-"/noheading 
