/* arspr517d.eq
   ...
   prints d/b outstanding receivables by Policy Number - Due Date Aging 
                                                         
*/  
description 
Direct Bill Outstanding Receivalbes by Policy Number - Due Date Aging - Sorted by Transaction Code with Totals by Transaction Code ;

define string l_report_title[60]=
"Direct Bill Aged Receivables - Due Date - Sorted by Transaction Code"
...
define signed ascii number l_direct_unearned = 0     

define signed ascii number l_direct_earned = l_net_due /decimalplaces=2

define unsigned ascii number l_days_past = (l_ending_date - 
arsbilling:due_date)
...
define string l_report_no = "ARSPR517D"  
...
sorted by  arsbilling:trans_code/total/newpage
           arsbilling:policy_no 
                                 

top of arsbilling:trans_code 
""/newline                    
arsbilling:trans_code/noheading/column=1
arscode:description/noheading /column=10 /newline=2
