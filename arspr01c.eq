...
define signed ascii number l_total_premium = if arsbilling:status one of "B",
 "C" then
...
--   arsbilling:due_date <= l_ending_date and
 if arsbilling:status one of "B" then 
    arsbilling:installment_amount - 
...
include "fonts.var"       
where arsfinder2:policy_no = 810100790
list
/nobanner
/domain="arsfinder2"
/nodefaults 
...
if arscontrol:invoice_message <> "" and
