...
12/07/2001 - dlp - if the a/r transcode = 25 do not include in the aging
                                                         
*/  
description Direct Bill Outstanding Receivalbes by Policy Number - Due Date Aging;                                                     

define string l_report_title[50]="     Direct Bill Aged Receivables - Due Date"

include "startend.inc"

--define date l_as_of = parameter/prompt="<NL>Enter As of Date"
define date l_as_of = l_ending_date 
...
where arsbilling:status <> "P"
and ((arsbilling:trans_date >= l_starting_date and
