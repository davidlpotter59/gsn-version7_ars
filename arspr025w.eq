...
Description Print the daily A/R transaction register of Write Offs, direct only, includes sur charges - booked;

include "startend.inc"

string l_prog_number = "ARSPR025W - Version 7.00"

define signed ascii number l_premium = if
arsbilling:trans_code one of 10,11,12,13,14,15,16,60,61,62,63,64,65,66 then
...
/domain="arsbilling"
/noreporttotals
/title="ARSBILLING File Daily Write Off Balancing Register - Booked"
