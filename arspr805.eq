/*  arspr805
    ...
    Report to list in summary arsbilling records - processed and run from arsin042 only - Negative balances only
*/

description 
List, in summary, NEGATIVE arsbilling records - select a starting and ending date that have a balance as of the date range entered - - Negative balances only
;
...
/pagewidth=220
/title="Accounts Receivable Outstanding Receivables - SUMMARY Negative Balances"
/nodetail 
/noreporttotals 
/pagelength=0
/xls
