...
/*  arspr047
    ...
    Report to list in Detail summary arsbilling records - processed and run from arsin042 only 
*/
...
define signed ascii number l_disbursement = if arsbilling:trans_code not one of 36 or 
arsbilling:status one of "T" then 
...
arsbilling:disbursement_amount -  l_cx_paid_amount 

-- l_voided_disbursement - l_cx_paid_amount 
...
/domain="arsbilling"
/pagewidth=140
/title="Detail Policy Summary Activity and Balance"
/noreporttotals 
