...
description 
List payments received by payment transaction date and transaction description sorted by trans code;
...
sorted by arspayment:trans_code/total 
--          arschksu:posted_date/total  
          l_type/newpage 
